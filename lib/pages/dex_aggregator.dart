  ...
  @override Widget build(BuildContext context){
    ...
    return Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children:[
      ...
      Row(children:[Expanded(child: TextField(controller: fromCtrl, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText:'Amount (USDT)', border: OutlineInputBorder()))),
        ...
        FilledButton(onPressed: (){ final amt=double.tryParse(fromCtrl.text)??0; final fee=app.estimateFee(amt); setState(()=>result='Estimated fee: $fee USDT · Router: 1inch (demo)');}, child: const Text('Estimate'))]),
