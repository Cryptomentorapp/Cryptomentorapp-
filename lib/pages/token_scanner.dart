...
class _Detail extends StatelessWidget{
  ...
  static String _risk(Map<String,dynamic> d){
    final mcap=d['market_data']?['market_cap']?['usd']??0; final vol=d['market_data']?['total_volume']?['usd']??0; int s=0;
    if(mcap is num && mcap<5000000) s+=2; if(vol is num && vol<200000) s+=1;
    if(s>=3) return 'HIGH RISK'; if(s>=2) return 'MEDIUM'; return 'SAFE';
  }
  static String _exp(Map<String,dynamic> d){
